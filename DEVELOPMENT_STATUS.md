...
- Production is now **9 tests**. `fairywriter_persistence` runs the 670-example
...
- A macOS CI production job now accompanies Linux. Automated native macOS and
  ...
  in `TESTING.md`.
- The native macOS production gate and final Qt 6.8.3 Linux container gate both
  pass **9/9**. The Linux AppImage also passes its X11 and Wayland bounded
  launches; its SHA-256 is
