# FocusWriter upstream changelog

This is the historical changelog inherited from FocusWriter 1.9.0. It is kept
for attribution and source-history context; it is not the FairyWriter release
log.
